...
class ImageEmbedder:
    ...
    def __init__(self):
        ...
        print(f"⚠️ CLIP model for image embeddings is currently DISABLED (commented out).")
    ...
    def embed_text(self, text: str) -> List[float]:
        """Mock implementation returning zero vector."""
        print(f"⚠️ [MOCK] Boosting zeros for text (CLIP disabled)")
        return [0.0] * 768
    
    @property
    def embedding_dim(self) -> int:
        """Get dimension of embeddings (Hardcoded to 768)."""
        return 768
