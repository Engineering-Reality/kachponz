...
// Diregistrasi terpisah dari registerTransactionRoutes dan SELALU dipanggil
// tanpa syarat di server.ts, lepas dari flag ENABLE_TRANSACTION_ROUTES —
// dipakai liveness check infra, tidak boleh ikut mati saat route transaksi
// di-nonaktifkan.
