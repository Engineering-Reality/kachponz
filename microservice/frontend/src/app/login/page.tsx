  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center bg-slate-100 p-4 md:p-8 font-sans">
      <div className="w-full max-w-6xl bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-[2.5rem] shadow-2xl shadow-slate-300/50 overflow-hidden flex min-h-[750px]">
        ...
        {/* Left Side: Form */}
        <div className="w-full lg:w-[55%] p-10 md:p-16 flex flex-col justify-center bg-white order-2 lg:order-1">
          <div className="max-w-md w-full mx-auto">
            ...
            <p className="text-[14px] text-slate-500 mb-8">Log in to your orchestrator administration dashboard.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between pt-2 pb-1">
                ...
                <a href="#" className="text-[13px] font-semibold text-indigo-600 hover:text-indigo-700 transition-colors">
                  Forgot password?
                </a>
              </div>
