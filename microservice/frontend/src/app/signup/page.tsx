      ...
      <div className="relative w-full max-w-6xl bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-[2.5rem] shadow-[0_0_40px_rgba(34,211,238,0.1)] overflow-hidden flex min-h-[750px]">
        ...
        <div className="w-full lg:w-[55%] p-10 md:p-16 flex flex-col justify-center bg-transparent">
          <div className="max-w-md w-full mx-auto">
            ...
            <p className="text-[14px] text-slate-400 mb-8">Register to access the enterprise administration dashboard.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-[12px] font-bold text-slate-300 mb-1.5 ml-1">Full Name</label>
