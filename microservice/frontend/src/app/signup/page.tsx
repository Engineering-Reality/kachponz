  ...
  return (
    <div className="relative min-h-[100dvh] flex items-center justify-center bg-background text-foreground p-4 md:p-8 font-sans overflow-hidden">
      ...
      <div className="relative w-full max-w-6xl bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl border border-slate-200 dark:border-slate-800 rounded-[2.5rem] shadow-xl dark:shadow-[0_0_40px_rgba(34,211,238,0.1)] overflow-hidden flex min-h-[750px]">
        ...
        {/* Right Side: Form */}
        <div className="w-full lg:w-[55%] p-10 md:p-16 flex flex-col justify-center bg-transparent">
          <div className="max-w-md w-full mx-auto">
            ...
            <h1 className="text-3xl font-extrabold text-foreground mb-2 tracking-tight">Create Account</h1>
            <p className="text-[14px] text-slate-600 dark:text-slate-400 mb-8">Register to access the enterprise administration dashboard.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-[12px] font-bold text-slate-700 dark:text-slate-300 mb-1.5 ml-1">Full Name</label>
