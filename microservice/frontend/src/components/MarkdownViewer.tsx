              ...
              return (
                <div className={`my-6 flex gap-3 p-4 rounded-xl border-l-4 ${style.border} ${style.bg} ${style.text}`}>
                  ...
                  <div className="flex-1 m-0 [&>p]:m-0 [&>p]:leading-relaxed text-[15px]">
                    <div className="font-medium mb-1">{titleCase}</div>
                    {processedChildren}
                  </div>
                </div>
              );
