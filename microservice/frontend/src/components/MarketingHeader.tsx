...
export function MarketingHeader() {
  ...
  return (
    <div className="fixed top-6 left-0 right-0 z-50 px-4 flex justify-center pointer-events-none">
      <header className="h-[68px] w-full max-w-[1400px] rounded-full bg-white/40 dark:bg-slate-900/50 backdrop-blur-[32px] ring-1 ring-slate-200/50 dark:ring-slate-700/50 ring-inset shadow-2xl shadow-slate-200/50 dark:shadow-none pointer-events-auto relative flex items-center">
        ...
        <div className="w-full h-full flex items-center justify-between px-6 rounded-full z-10">
          ...
          <div className="flex items-center gap-8">
            <Link href="/" className="flex items-center gap-3">
              ...
              <span className="font-semibold text-lg tracking-tight text-foreground hidden lg:block">Amadeus</span>
            </Link>
                ...
                return (
                  <Link
                    ...
                    className={`text-[13px] font-semibold transition-colors ${
                      isActive ? "text-pink-600 dark:text-fuchsia-400" : "text-slate-900 dark:text-slate-300 hover:text-pink-600 dark:hover:text-fuchsia-400"
                    }`}
                  >
                    {label}
                  </Link>
