  ...
  return (
    <section className="bg-transparent py-24 relative z-10 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row rounded-[2rem] overflow-hidden border border-slate-800 shadow-2xl relative">
          
          {/* Legacy RPA Side - Rigid, Boxed-in, Monospaced */}
          <div className="w-full lg:w-[40%] bg-slate-900 border-b lg:border-b-0 lg:border-r border-slate-800 p-10 flex flex-col relative overflow-hidden">
            <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMiIgY3k9IjIiIHI9IjEiIGZpbGw9IiMzMzQxNTUiLz48L3N2Zz4=')] opacity-20 pointer-events-none" />
            <h4 className="font-mono text-xl text-slate-500 mb-8 border-b border-slate-800 pb-4">Legacy RPA</h4>
            <ul className="space-y-6 flex-1 relative z-10">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  ...
                  <span className="font-mono text-sm text-slate-400">{item}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="w-full lg:w-[60%] bg-slate-950 p-10 lg:p-14 flex flex-col relative overflow-hidden group">
            ...
            <div className="absolute -top-40 -right-40 w-96 h-96 bg-cyan-500/20 blur-[100px] rounded-full pointer-events-none" />
            ...
            <ul className="space-y-6 flex-1 relative z-10">
              {[
                ...
                <li key={i} className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="font-semibold text-slate-200 block mb-1">{item.title}</span>
